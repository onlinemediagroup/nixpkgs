...
clangStdenv.mkDerivation rec {
  ...
  cctools_port = fetchFromGitHub {
    ...
    sha256 =
    "0nj1q5bqdx5jm68dispybxc7wnkb6p8p2igpnap9q6qyv2r9p07w";
  };
  ldid = fetchFromGitHub {
    ...
    sha256 =
    "1a6zaz8fgbi239l5zqx9xi3hsrv3jmfh8dkiy5gmnjs6v4gcf6sf";
  };
  src = requireFile rec {
    name = "iPhoneOS9.2.sdk.tar.xz";
    sha256 =
    "1l2h3cic9psrq3nmfv9aaxkdk8y2pvr0iq6apj87mb3ms9a4cqrq";
    message = ''
  ...
  buildInputs = 
  [ git xz gnutar openssl automake autoconf libtool clang ];
